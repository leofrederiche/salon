...
class SalonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salon" do
    assert_difference('Salon.count') do
      post salons_url, params: { salon: { city: @salon.city, district: @salon.district, email: @salon.email, header: @salon.header, name: @salon.name, phone: @salon.phone, street: @salon.street } }
    end
  ...
  test "should update salon" do
    patch salon_url(@salon), params: { salon: { city: @salon.city, district: @salon.district, email: @salon.email, header: @salon.header, name: @salon.name, phone: @salon.phone, street: @salon.street } }
